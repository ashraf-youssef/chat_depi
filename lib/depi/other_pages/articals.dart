...
final List<Map<String, String>> photoData = [
  {
    "title": "Thank to DEPI",
    "description": """"
نوجه خالص الشكر و التقدير للمجهودات العظيمة لمبادرة "رواد مصر الرقمية "
 على أدائها مع جميع الطلبه بالبحث عما هو مناسب للجميع من أجل الإرتقاء للأفضل
  لجميع أبناء مصر الكرام

شكرا من مجموعة مطوري تطبيقات الهاتف المحمول
CAI1_SWD4_G2e
"""
  },
  {
...
Project IDX, currently in beta, is an AI-assisted workspace for full-stack, multiplatform app development in the cloud. IDX supports Dart and Flutter. For more information, check out the Project IDX Getting Started guide.
...
#
Code push, or the ability to push app updates directly to a user's device, isn't directly supported by Flutter. However, we are aware of a third party solution, called Shorebird. Note that this is not an official endorsement or recommendation.
...
Note
The release engine binary used to include LLVM IR (bitcode). However, Apple deprecated bitcode in Xcode 14 and removed support, so it has been removed from the Flutter 3.7 release.
...
Flutter supports building ahead-of-time (AOT) compiled libraries for x86-64, armeabi-v7a, and arm64-v8a.

Apps built for ARMv7 or ARM64 run fine (using ARM emulation) on many x86-64 Android devices.
...
#
Yes, Flutter supports calling into the platform, including integrating with Java or Kotlin code on Android, and Swift or Objective-C code on iOS. This is enabled by a flexible message passing style where a Flutter app might send and receive messages to the mobile platform using a BasicMessageChannel.
...
You can also engage with other developers on the Flutter Discord.
...
"""
  },
  {
    ...
    "description": """"
رابط مصر الرقمية : https://depi.gov.eg/
كود المجموعة : CAI1_SWD4_G2e
اسم المسار التدريبي: Mobile App Developer
عدد المحاضرات أسبوعيا: ثلاثة محاضرات اسبوعيا (محاضرتين اونلاين+ محاضرة حضوري)
مواعيد المحاضرات أسبوعياً:
- الاحد من 6 الي 9 مساء اونلاين
- الأربعاء من 6 الي 9  مساءً  اون لاين
- الجمعة من 2 الي 5 مساءً حضوري
تاريخ بدء أول محاضرة  :
* الاحد الموافق 12 مايو 2024
بيانات مركز التدريب للحضور
محافظة التدريب:	 القاهرة
منطقة مركز التدربب : مدينة نصر
اسم المركز/ نيوهورايزون - القاهرة
عنوان مركز التدربب/ 8 شارع محمد مصطفي حمام – خلف بيتزا هت – عباس العقاد – الدور 4
أيام الحضور: نهاية الاسبوع
======================
"""
  },
  {
        ...
        child: Container(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (BuildContext context, int index) {
              final photoInfo = photoData[index];
              return InkWell(
                onTap: () {
...
final List<String> _images = [
  ...
  'https://cdn.dribbble.com/users/2234546/screenshots/5633840/media/e04c064c88da6ea1d78461fab17ed4a5.png',
  'https://cdn-icons-png.flaticon.com/512/1810/1810852.png',
  'https://cdn-icons-png.flaticon.com/512/1810/1810852.png',
];
